  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="newTaskModalLabel"><i class="fas fa-tasks me-2"></i>Create New Task</h5>
      ...
      <form id="taskForm">
        ...
        <div class="modal-footer d-flex justify-content-between">
          ...
          <button type="submit" class="btn btn-primary"><i class="fas fa-check-circle me-1"></i>Save Task</button>
        </div>
      </form>
    </div>
  </div>
