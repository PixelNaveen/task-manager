 <div class="d-flex justify-content-between align-items-center bg-white rounded-3 shadow-sm px-4 py-2 mb-4">
     ...
     <div class="d-flex align-items-center gap-3">
         ...
         <div class="dropdown position-relative">
             ...
             <ul class="dropdown-menu dropdown-menu-end shadow-sm p-2" id="notifDropdown">
     ...
     <div class="col-6 col-md-3">
         <div class="card">
             <div class="card-body">
                 ...
                 <p id="allTasksCount" class="card-text fs-4">--</p>
             </div>
         </div>
     </div>
     <div class="col-6 col-md-3">
         <div class="card">
             <div class="card-body">
                 ...
                 <p id="completedTasksCount" class="card-text fs-4">--</p>
             </div>
         </div>
     </div>
     <div class="col-6 col-md-3">
         <div class="card">
             <div class="card-body">
                 ...
                 <p id="pendingTasksCount" class="card-text fs-4">--</p>
             </div>
         </div>
     </div>
     <div class="col-6 col-md-3">
         <div class="card">
             <div class="card-body">
                 ...
                 <p id="overdueTasksCount" class="card-text fs-4">--</p>
             </div>
         </div>
     </div>
 </div>